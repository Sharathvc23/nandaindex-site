...
(function () {
  ...
  var DATA = [
    ...
    },
    {
      ...
      host: 'list39.org', region: 'AWS', ttl: 900, version: 'n/a',
      mediaType: MEDIA.card, identityType: 'dns',
      url: 'https://agentcards.list39.org/moonbakery.com/orders.json',
      meta: {
        'org.projectnanda.agentCardHost': 'list39.org',
    ...
    },
    {
      ...
      host: 'list39.org', region: 'Azure', ttl: 900, version: 'n/a',
      mediaType: MEDIA.card, identityType: 'email',
      url: 'https://agentcards.list39.org/personal/john%40hotmail.com/card.json',
      meta: {
